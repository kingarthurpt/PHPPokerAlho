...
class DeckTest extends \Tests\BaseTestCase
{
    private $deck;
    ...
    {
        $this->assertEquals([], $this->getPropertyValue($this->deck, 'items'));
    }
    ...
    public function testAddCard()
    {
        ...
        $this->assertNotContains(
            $card,
            $this->getPropertyValue($this->deck, 'items')
        );
    ...
    {
        $this->assertFalse($this->deck->addCards([]));
        ...
        $this->assertTrue($this->deck->addCards($cards));
    ...
    {
        $this->assertEquals(
            count($this->getPropertyValue($this->deck, 'items')),
            $this->deck->getSize()
        );
    }
